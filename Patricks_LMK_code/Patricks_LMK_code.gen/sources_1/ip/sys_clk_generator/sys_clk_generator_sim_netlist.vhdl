...
--               q:/Mimas_Firmware/Patricks_LMK_code/Patricks_LMK_code.gen/sources_1/ip/sys_clk_generator/sys_clk_generator_sim_netlist.vhdl
...
entity sys_clk_generator_sys_clk_generator_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of sys_clk_generator_sys_clk_generator_clk_wiz : entity is "sys_clk_generator_clk_wiz";
end sys_clk_generator_sys_clk_generator_clk_wiz;

architecture STRUCTURE of sys_clk_generator_sys_clk_generator_clk_wiz is
  signal clk_in1_sys_clk_generator : STD_LOGIC;
  signal clkfbout_buf_sys_clk_generator : STD_LOGIC;
  signal clkfbout_sys_clk_generator : STD_LOGIC;
  signal ser_clk_sys_clk_generator : STD_LOGIC;
  signal sys_clk_sys_clk_generator : STD_LOGIC;
...
clkin1_ibufgds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_sys_clk_generator
    );
clkout1_buf: unisim.vcomponents.BUFG
     port map (
      I => sys_clk_sys_clk_generator,
      O => sys_clk
    );
clkout2_buf: unisim.vcomponents.BUFG
     port map (
      I => ser_clk_sys_clk_generator,
      O => ser_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_sys_clk_generator,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => sys_clk_sys_clk_generator,
      CLKOUT0B => NLW_mmcm_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => ser_clk_sys_clk_generator,
...
begin
inst: entity work.sys_clk_generator_sys_clk_generator_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      locked => locked,
