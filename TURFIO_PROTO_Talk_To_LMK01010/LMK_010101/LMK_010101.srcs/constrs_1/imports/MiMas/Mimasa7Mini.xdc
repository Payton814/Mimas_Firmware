...
set_property -dict  { PACKAGE_PIN "C13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {LMKclk_N}];                        # IO_L12N_T1_MRCC_15            Sch = GPIO_21_N
set_property -dict  { PACKAGE_PIN "D13"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {LMKclk_P}];                        # IO_L12P_T1_MRCC_15            Sch = GPIO_21_P
...
set_property -dict  { PACKAGE_PIN "D10"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {SYNC}];                       # IO_0_15                       Sch = GPIO_34
set_property -dict  { PACKAGE_PIN "B16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {LE}];                       # IO_L10N_T1_AD11N_15           Sch = GPIO_24_N
set_property -dict  { PACKAGE_PIN "C16"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {dataline}];                       # IO_L10P_T1_AD11P_15           Sch = GPIO_24_P
set_property -dict  { PACKAGE_PIN "A15"   IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {clk2data}];                       # IO_L9N_T1_DQS_AD3N_15         Sch = GPIO_25_N
